...
<script>
    export default {
      ...
      methods: {
        ...
        get_leaves(){
          this.$axios.post('/api/leave_deals', {status : "vice_general_manager"})
            .then((response)=> {
        ...
        show(index){
          this.$axios.post('/api/admit', {status : "vice_general_manager",d_id:this.data7[index].d_id, uid:this.data7[index].uid,admission: true})
            .then((response)=> {
        ...
        remove(index){
          this.$axios.post('/api/admit', {status : "vice_general_manager",d_id:this.data7[index].d_id, uid:this.data7[index].uid,admission: false})
            .then((response)=> {
              console.log(response);
            })
            .catch((error)=> {
