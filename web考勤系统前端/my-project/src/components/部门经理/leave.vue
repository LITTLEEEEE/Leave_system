        ...
        handleSubmit (name) {
          this.$refs[name].validate((valid) => {
            if (valid) {
              ...
              this.$axios.post('/api/leave2', {status:'department_manager', id: this.formValidate.id, reason: this.formValidate.reason, item:this.formValidate.item, time_start: this.dataValue[0],time_end: this.dataValue[1],days:this.formValidate.days})
                .then((response) => {
